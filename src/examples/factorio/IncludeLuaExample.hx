...
/**
    ...
    Path is relative to the generated file, here that should be `control.lua`.
...
/** 
    IncludeLuaExample - How to use an existing lua file or library
**/
class IncludeLuaExample
{
    ...
    public static function __init__()
    {
        ...
        // not at the position of the includeFile macro!
    ...
    function test(event:TickEvent)
    {
        ...
        // Method Nr.3
        // Call arbitrary lua code

        var ret:String = untyped __lua__("(function(param) 
            return \"foo\" .. param 
        end)(\"bar\")
        ");
